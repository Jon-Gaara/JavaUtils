...
public class SetExcelValue {
     ...
     * 
     */
    public static void setTheCellValue(CellStyleControl styleFactory, Cell cell, int index, Object object,
        CellConfig config) throws SecurityException, NoSuchMethodException, IllegalArgumentException,
        ...
        if ("index".equals(config.getColName())) {
            ...
            if (object instanceof Map) {
                ...
                String methodName =
                    config.getFieldName().substring(0, 1).toUpperCase().concat(config.getFieldName().substring(1));
     ...
     * @param value
     */
    public static void setValueAndStyleByType(CellStyleControl styleFactory, Cell cell, CellTypeEnum type, Object value,
        CellStyle cellStyle) {
